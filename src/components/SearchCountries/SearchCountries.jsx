            ...
            <div className="SearchCountries">
                ...
                {this.state.countries.length > 0 ? (
                    this.state.countries.map((country, index) => {
                     let flagSrc = `https://coronastatistics.live/assets/flags/${this.state.flags[country.country]}.svg`;
                        return <CardCountry flagCode={`${flagSrc.toLowerCase()}`} country={country} key={index} />;
                    })
                ) : (
